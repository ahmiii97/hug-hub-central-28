          ...
          <div className="mx-auto grid h-20 max-w-[1600px] grid-cols-12 items-center gap-6 px-6">
            ...
            <div className="col-span-9">
              <label className="group flex h-12 items-center gap-3 border border-white/10 bg-white/[0.04] pl-4 pr-1 transition-colors focus-within:border-accent">
                ...
                <input type="text" placeholder="Search Spares Automation..." className="flex-1 bg-transparent font-mono text-[13px] tracking-wide text-white placeholder:text-white/40 focus:outline-none" />
      ...
      <section className="py-24 bg-surface">
        <div className="mx-auto max-w-[1600px] px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
             <div>
                <h2 className="font-display text-3xl font-bold uppercase tracking-tight">Our Mission</h2>
             ...
             <div>
                <h2 className="font-display text-3xl font-bold uppercase tracking-tight">Trade Support</h2>
                <p className="mt-6 text-ink-muted leading-relaxed">
